const CACHE = "gan-mazor-v12-20260728";
const STATIC_ASSETS = [
  "./styles.css", "./admin.css", "./manifest.json",
  "./assets/icon.svg", "./assets/icon-192.png", "./assets/icon-512.png", "./assets/icon-maskable-192.png", "./assets/icon-maskable-512.png", "./assets/staff-yael.svg", "./assets/staff-michal.svg",
